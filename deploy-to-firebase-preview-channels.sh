...
DEPLOYED_DATA_OBJECT=`echo ${RESULT} | jq -r '."comment-via-travis-ci"'`
SITE=`echo ${DEPLOYED_DATA_OBJECT} | jq -r .site`
URL=`echo ${DEPLOYED_DATA_OBJECT} | jq -r .url`
EXPIRE_TIME_UTC=`echo ${DEPLOYED_DATA_OBJECT} | jq -r .expireTime`
